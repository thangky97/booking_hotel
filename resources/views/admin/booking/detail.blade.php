					...
					<div class="col-xl-9 col-xxl-8">
						<div class="card">	
							<div class="card-header border-0 pb-0">
								<h4 class="card-title">Đơn hiện tại</h4>
							</div>
							<div class="card-body">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div>
										...
										<h4 class="mb-0">Hoàng Cun</h4>
									</div>
								</div>
								<div class="row mt-4 pt-3">
									<div class="col-8">
										<a class="btn btn-dark light btn-block" href="javascript:void(0);">Sửa hồ sơ</a>
									</div>
									<div class="col-4">
								...
								<ul class="user-info-list">
									...
									<li>
										...
										<span class="overflow-hidden">hoangcun@mail.com</span>
									</li>
									<li>
							...
							<table class="table card-table  display mb-4 dataTablesCard booking-table table-responsive-lg " id="guestTable-all">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="guest-bx">
												<img class="me-3" src="{{ asset('admin/images/hotel/pic11.jpg')}}" alt="">
												<div>
									...
									<tr>
										...
										<td>
											<div class="guest-bx">
												<img class="me-3" src="{{ asset('admin/images/hotel/pic22.jpg')}}" alt="">
												<div>
										...
										<td>
											<div class="guest-bx">
												<div id="carouselExampleControls" class="carousel slide me-3" data-bs-ride="carousel">
													<div class="carousel-inner">
														<div class="carousel-item active">
															<img src="{{ asset('admin/images/hotel/pic11.jpg')}}" class="d-block w-100" alt="...">
														</div>
														<div class="carousel-item">
															<img src="{{ asset('admin/images/hotel/pic22.jpg')}}" class="d-block w-100" alt="...">
														</div>
														<div class="carousel-item">
															<img src="{{ asset('admin/images/hotel/pic33.jpg')}}" class="d-block w-100" alt="...">
														</div>
													</div>
												...
												<div>
													...
													<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Deluxe B-0004</a></h4>
												</div>
											</div>
										</td>
										<td>
