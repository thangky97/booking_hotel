                ...
                <div class="card">
                            ...
                            <div class="row-xl-9">
                                <div>
                                    ...
                                    <h4 class="mb-0 card-title">
                                        ...
                                        {{ $format = date('d/m/Y', strtotime($booking->checkout_date)) }}
                                    </h4>
                                </div>
                    ...
                    <div>
                        <div class="text-end" style="margin-right: 30px">
                            <div class="btn btn-primary light btn-sl-sm" style="width: 17%; margin-right: 10px"><span class="me-2"><i class="fa fa-times"></i></span><a href="{{ route('route_BackEnd_Bookings_List') }}">Quay lại</a>
                            </div>
                            @if ($booking->status_booking !=2)
                            <div class="btn btn-danger light btn-sl-sm" style="width: 17%"><span class="me-2"><i class="fa fa-times"></i></span><a href="{{ route('route_BackEnd_Bookings_Cancelbooking',$booking->id) }}">Hủy đơn</a>
                            </div>
                            @endif
                        </div>
                    </div>
