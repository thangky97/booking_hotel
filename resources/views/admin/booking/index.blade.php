                        ...
                        <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                            <div class="card-tabs mt-3 mt-sm-0 mb-xxl-0 mb-4">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#Active" role="tab">Còn
                                            hạn</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div>
                                <a href="{{ route('route_BackEnd_Bookings_Adduser') }}" class="btn btn-info mb-xxl-0 mb-4"
                                    style="margin-right: 30px"><i class="bi bi-minecart-loaded"></i> Thêm mới</a>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div style="width: 100px">
                                                                <h6>{{ $format = date('d-m-Y', strtotime($item->checkin_date)) }}
                                                                </h6>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                            <div style="width: 100px">
                                                                <h6>{{ $format = date('d-m-Y', strtotime($item->checkout_date)) }}
                                                                </h6>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            @if ($item->status_pay == 0)
                                                                <form
                                                                    action="{{ route('route_BackEnd_Bookings_Updatepay', $item->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <input name="status_pay" value="1" hidden>
                                                                    <button type="submit"
                                                                        onclick="return confirm('Đơn hàng đã thanh toán ?')"
                                                                        class="btn btn-danger w180">Chưa thanh toán</button>
                                                                </form>
                                                            @else
                                                                <input name="status_pay" value="1" hidden>
                                                                <button type="submit" class="btn btn-success w180"
                                                                    onclick="return confirm('Trạng thái đã thanh toán. Liên hệ quản trị viên để thay đổi !')">Đã
                                                                    thanh toán</button>
                                                            @endif
                                                        </td>
                                                        <td class="text-center">
                                                            ...
                                                            <div class="dropdown dropstart">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('route_BackEnd_Bookings_Detail', $item->id) }}">Chi
                                                                        tiết</a>
                                                                    @if (in_array($item->id, $list))
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('route_BackEnd_Bill', $item->id) }}">Xem
                                                                            Bill</a>
                                                                    @else
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('route_BackEnd_Bill_Room', $item->id) }}">Tạo
                                                                            Bill</a>
                                                                    @endif
