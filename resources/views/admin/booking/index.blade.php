									...
									<table class="table card-table default-table display mb-4 dataTablesCard table-responsive-xl " id="guestTable-all">
                                        ...
                                        @foreach($booking as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <h5>{{$item->checkin_date}}</h5>
                                                        <span class="fs-14">08:29 AM</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        <h5>{{$item->checkout_date}}</h5>
                                                        <span class="fs-14">08:29 AM</span>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td><p>{{$item->cate_room_id}}</p></td>
                                                <td><p>{{$item->status_booking}}</p></td>
                                                <td><p>{{$item->status_pay}}</p></td>
                                                <td><p>{{$item->staff_id}}</p></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
									</table>
