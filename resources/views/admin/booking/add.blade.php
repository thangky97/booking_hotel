                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="needs-validation" action="{{route('route_BackEnd_Bookings_Create',$usernew->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="name" class="form-control" placeholder="Nhập tên..." value="{{$usernew->name}}">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="email" class="form-control" placeholder="Nhập email..." value="{{$usernew->email}}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" name="cccd" class="form-control" placeholder="Nhập số cccd..." value="{{$usernew->cccd}}">
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="address" class="form-control" placeholder="Nhập địa chỉ..." value="{{$usernew->address}}">
                                                <div class="invalid-feedback">
                                                    Please enter a password.
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" name="date" class="form-control" placeholder="Nhập ngày" value="{{$usernew->date}}">
                                                <div class="invalid-feedback">
                                                    Please enter a password.
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" name="phone" class="form-control" placeholder="Nhập số điện thoại..." value="{{$usernew->phone}}">
                                                <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" name="checkin_date" class="form-control" placeholder="Nhập ngày">
                                                <div class="invalid-feedback">
                                                    Please enter a password.
                                                </div>
                                                @if(isset($error))
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" name="checkout_date" class="form-control" placeholder="Nhập ngày">
                                                <div class="invalid-feedback">
                                                    Please enter a password.
                                                </div>
                                                @if(isset($error))
                                                    ...
                                                    <table class="table card-table default-table display mb-4 dataTablesCard table-responsive-xl " id="guestTable-all">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="guest-bx ">
                                                                        <img class="me-3 " src="{{asset("storage/".$item->images)}}" alt="">
                                                                        <div>
                                    ...
                                    <button type="submit" class="btn btn-primary"><span class="me-2"><i class="fa fa-paper-plane"></i></span>Thêm mới</button>
                                </div>
                            </form>
                        </div>
                    </div>
