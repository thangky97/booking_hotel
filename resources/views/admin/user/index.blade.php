        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                    ...
                    <div>
                        <a href="{{ route('route_BackEnd_Users_Add') }}" class="btn btn-info mb-xxl-0 mb-4"><i class="bi bi-people-fill"></i> Thêm mới</a>
                        <a href="{{ route('route_BackEnd_Bookings_Adduser') }}" class="btn btn-primary mb-xxl-0 mb-4"><i class="far fa-file-word me-2"></i>Đặt phòng</a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="guest-bx">
                                                <div>
                                                    <h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">{{ $user->name }}</a></h4>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown dropstart">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('route_BackEnd_Bookings_Add', ['id' => $user->id]) }}">Đặt
                                                        phòng</a>
                                                    <a class="dropdown-item" href="{{ route('route_BackEnd_Users_Edit', ['id' => $user->id]) }}">Sửa</a>
                                                    <a class="dropdown-item" href="{{ route('route_BackEnd_Bookings_History', ['id' => $user->id]) }}">Lịch sử đặt phòng</a>
