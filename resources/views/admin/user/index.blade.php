        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                    ...
                    <div>
                        <a href="{{ route('route_BackEnd_Users_Add') }}" class="btn btn-info mb-xxl-0 mb-4"><i class="fa fa-users me-2"></i>Thêm mới</a>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown dropstart">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('route_BackEnd_Bookings_Add', ['id' => $user->id]) }}">Đặt phòng</a>
