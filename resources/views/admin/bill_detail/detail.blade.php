                ...
                <div class="card">
                        ...
                        <div>
                            <div class="container">
                                <ul class="ks-cboxtags">
                                    ...
                                    <li><input type="checkbox" id="{{$sv->id}}" value=""><label for="{{$sv->id}}">{{$sv->name}}</label></li>
                                    @endforeach
                                </ul>
                    ...
                    <div class="" style="text-align: center;">
                        <div class="me-10 mb-sm-0 mb-3">
                            <a href="" class="btn btn-info mb-xxl-0 mb-4 btn-submit"><i class="flaticon-022-copy"></i>Tiếp Tục</a>
                        </div>
                    </div>
                </div>
