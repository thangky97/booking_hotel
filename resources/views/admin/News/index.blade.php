				...
				<div class="row">
					<div class="col-xl-12">
						<div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
							...
							<div>
								<a href="{{route('route_BackEnd_News_Add')}}" class="btn btn-info mb-xxl-0 mb-4"><i class="bi bi-newspaper"></i> Thêm mới</a>
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td class="text-center"><img src="{{asset('storage/'. $n->images)}}" alt="" width="100px"></td>
                                                    ...
                                                    <td>
                                                        <a href="{{route('route_BackEnd_News_Detail', $n->id)}}" style="margin-left: 10px"><button class="btn btn-primary">Sửa</button></a>
                                                    </td>
											</tr>
                                            @endforeach
										</tbody>
