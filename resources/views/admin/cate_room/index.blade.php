        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                    ...
                    <div>
                        <a href="{{route('route_BackEnd_Categoryrooms_Add')}}" class="btn btn-info mb-xxl-0 mb-4"><i class="fa fa-bed me-2"></i>Thêm mới</a>
                                            ...
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('route_BackEnd_Categoryrooms_Detail', $item->id)}}">Edit</a>
