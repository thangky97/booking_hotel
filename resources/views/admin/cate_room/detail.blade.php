                    ...
                    <div class="card-body">
                        ...
                        <div class="email-right-box ms-0 ms-sm-2 ms-sm-0">
                                ...
                                <form action="{{ route('route_BackEnd_Categoryrooms_Detail', $id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            <input type="text" name="name" id="name" class="form-control" value="{{old('name',  $editCate->name)}}">
                                            <span id="mes_sdt"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-md-3 col-sm-4 control-label">Giá Phòng<span class="text-danger">(*)</span></label>
                            ...
                            <div class="text-start mt-4 mb-3">
                                ...
                                <button class="btn btn-danger light btn-sl-sm" type="button"><span class="me-2"><i class="fa fa-times"></i></span><a href="{{ route('route_BackEnd_Categoryrooms_List') }}">Quay Lại</a></button>
                            </div>
                        </div>
