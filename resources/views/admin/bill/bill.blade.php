            ...
            <div class="col-xl-9 col-xxl-8">
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        <h2 <?= $booking->status_pay == 1 ? 'class="text-success"' : 'class="text-danger"' ?>>Thanh toán
                        </h2>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center" style="font-weight: bold;">
                                    ...
                                    <td>
                                        <i><b>
                                                @if ($voucher == null)
                                                {{ number_format($total_money_room_service) }}đ
                                                @else
                                                {{ number_format($total_money_room_service - $voucher->discount) }}đ
                                                @endif
                                            </b></i>
                                    </td>
                                </tr>
                    ...
                    <div class="" style="text-align: center;">
                        <div class="me-10 mb-sm-0 mb-3">
                            <a href="{{ route('printOrder', $booking->id) }}" target="_blank" class="btn btn-info mb-xxl-0 mb-4 btn-submit"><i class="flaticon-022-copy"></i> In hóa
                                đơn</a>
                            <a href="{{ route('route_BackEnd_Bookings_List') }}" class="btn btn-danger mb-xxl-0 mb-4 btn-submit"><i class="fa fa-times"></i> Danh
                                sách</a>
                        </div>
                    </div>
                </div>
