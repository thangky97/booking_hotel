                            ...
                            <div class="compose-content">
                                <form action="{{ route('route_BackEnd_Category_News_Detail', $id) }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-md-3 col-sm-4 control-label">Tên danh mục tin tức<span
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-sm-4 control-label">Trạng Thái <span class="text-danger">(*)</span></label>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="status" value = "2" {{(isset($editCateNews) && $editCateNews->status === 2) ? 'checked' : ''}}>
                                                <label class="form-check-label" for="flexRadioDefault1" >khoat</label>
                                                <div>
                                                    <input class="form-check-input" type="radio" name="status" value = "1" {{(isset($editCateNews) && $editCateNews->status === 1) ? 'checked' : ''}}>
