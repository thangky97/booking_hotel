                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="email-left-box px-0 mb-3">
                                <div class="p-0">
                                    <a href="" class="btn btn-primary btn-block">Thêm danh mục tin tức</a>
                                </div>
                            </div>
                                ...
                                <div class="compose-content">
                                    <form action="{{ route('route_BackEnd_Category_News_saveAdd') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-md-3 col-sm-4 control-label">Tên danh mục<span
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="text-start mt-4 mb-3">
                                                ...
                                                <button class="btn btn-danger light btn-sl-sm" type="button"><span
                                                        ...
                                                        href="{{ route('route_BackEnd_Category_News_List') }}">Quay
                                                        Lại</a></button>
                                            </div>
                                        </div>
                                    </form>
