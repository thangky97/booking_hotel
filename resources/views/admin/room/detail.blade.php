                        ...
                        <div class="content-body">
                            ...
                            <div class="email-right-box ms-0 ms-sm-2 ms-sm-0">
                                <div class="compose-content">
                                    <form class=""
                                        action="{{ route('route_BackEnd_Rooms_Update', ['id' => request()->route('id')]) }}"
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control bg-transparent"
                                                    placeholder=" Tên phòng" value="{{ $objItem->name }}">
                                                @error('name')
                                                    <div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="cate_room" id="" class="form-control bg-transparent">
                                                    @foreach ($cate_rooms as $cate)
                                                        <option value="{{ $cate->id }}" <?php if ($cate->id == $objItem->cate_room) : ?>selected
                                                            <?php endif ?>>
                                                            {{ $cate->name }}
                                                        </option>
                                                    @endforeach
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="floor" id="" class="form-control bg-transparent">
                                                    <option value="1" <?php if ($objItem->cate_room == '1') {
                                                        echo 'selected';
                                                    } ?>>Tầng 1</option>
                                                    <option value="2" <?php if ($objItem->cate_room == '2') {
                                                        echo 'selected';
                                                    } ?>>Tầng 2</option>
                                                    <option value="3" <?php if ($objItem->cate_room == '3') {
                                                        echo 'selected';
                                                    } ?>>Tầng 3</option>
                                                    <option value="4" <?php if ($objItem->cate_room == '4') {
                                                        echo 'selected';
                                                    } ?>>Tầng 4</option>
                                                    <option value="5" <?php if ($objItem->cate_room == '5') {
                                                        echo 'selected';
                                                    } ?>>Tầng 5</option>
                                                    <option value="6" <?php if ($objItem->cate_room == '6') {
                                                        echo 'selected';
                                                    } ?>>Tầng 6</option>
                                                    <option value="7" <?php if ($objItem->cate_room == '7') {
                                                        echo 'selected';
                                                    } ?>>Tầng 7</option>
                                                    <option value="8" <?php if ($objItem->cate_room == '8') {
                                                        echo 'selected';
                                                    } ?>>Tầng 8</option>
                                                    <option value="9" <?php if ($objItem->cate_room == '9') {
                                                        echo 'selected';
                                                    } ?>>Tầng 9</option>
                                                    <option value="10" <?php if ($objItem->cate_room == '10') {
                                                        echo 'selected';
                                                    } ?>>Tầng 10</option>
                                                    <option value="11" <?php if ($objItem->cate_room == '11') {
                                                        echo 'selected';
                                                    } ?>>Tầng 11</option>
                                                    <option value="12" <?php if ($objItem->cate_room == '12') {
                                                        echo 'selected';
                                                    } ?>>Tầng 12</option>
                                                    <option value="13" <?php if ($objItem->cate_room == '13') {
                                                        echo 'selected';
                                                    } ?>>Tầng 13</option>
                                                    <option value="14" <?php if ($objItem->cate_room == '14') {
                                                        echo 'selected';
                                                    } ?>>Tầng 14</option>
                                                    @error('floor')
                                                        <div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="adult" class="form-control bg-transparent"
                                                    placeholder=" Số lượng người lớn" value="{{ $objItem->adult }}">
                                                @error('adult')
                                                    <div>
                                                        <p class="text-danger">{{ $message }}</p>
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="childrend" class="form-control bg-transparent"
                                                    placeholder=" Số lượng trẻ em" value="{{ $objItem->childrend }}">
                                                @error('childrend')
                                                    <div>
                                                        <p class="text-danger">{{ $message }}</p>
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="bed" class="form-control bg-transparent"
                                                    placeholder=" Số giường" value="{{ $objItem->bed }}">
                                                @error('bed')
                                                    <div>
                                                        <p class="text-danger">{{ $message }}</p>
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="status" id="" class="form-control bg-transparent">
                                                    <option class="text-success" value="1" <?php if ($objItem->status == '1') {
                                                        echo 'selected';
                                                    } ?>>Có
                                                        thể sử dụng</option>
                                                    <option class="text-danger" value="2" <?php if ($objItem->status == '2') {
                                                        echo 'selected';
                                                    } ?>>Đang
                                                        sử dụng</option>
                                                    <option class="text-warning" value="3" <?php if ($objItem->status == '3') {
                                                        echo 'selected';
                                                    } ?>>Đang
                                                        bảo trì</option>
                                                </select>
