                        ...
                        <div class="card-body">
                            ...
                            <div class="email-right-box ms-0 ms-sm-2 ms-sm-0">
                                ...
                                <div class="compose-content">
                                    <form action="{{ route('route_BackEnd_Voucher_editpost',$voucher->id) }}" method="post" >
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            <input type="text" name="name" id="name" class="form-control" value="{{$voucher->name}}" placeholder=""
                                            >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            <input type="text" name="code" id="code" class="form-control" value="{{$voucher->code}}" placeholder=""
                                            >
                                            <span id="mes_sdt"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            <input type="text" name="discount" id="discount" class="form-control"value="{{$voucher->discount}}"
                                                   >

                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-md-3 col-sm-4 control-label">Giới hạn số lần <span
                                                    class="text-danger">(*)</span></label>

                                        <div class="col-md-9 col-sm-8">
                                            <input type="text" name="limit" id="limit" class="form-control" value="{{$voucher->limit}}"
                                                  >
                                            <span id="mes_sdt"></span>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" name="date_start" class="form-control" value="{{$voucher->date_start}}"
                                                >
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" name="date_end" class="form-control" value="{{$voucher->date_end}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="text-start mt-4 mb-3">
                                            ...
                                            <button class="btn btn-primary btn-sl-sm me-2" type="submit"><span class="me-2"><i
                                                            class="fa fa-paper-plane"></i></span>Update</button>
