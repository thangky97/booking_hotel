				...
				<div class="row">
					<div class="col-xl-12">
						<div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
							...
							<div>
								<a href="{{route('route_BackEnd_properties_Add')}}" class="btn btn-info mb-xxl-0 mb-4"><i
												...
												<td>
													<div class="dropdown dropstart">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="{{route('route_BackEnd_properties_Detail', $p->id)}}">Edit</a>
															<a onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="dropdown-item"
																href="{{route('route_BackEnd_properties_Delete', $p->id)}}">Delete</a>
														</div>
													</div>
												</td>
											</tr>
