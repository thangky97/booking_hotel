                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="email-left-box px-0 mb-3">
                                <div class="p-0">
                                    <a href="" class="btn btn-primary btn-block">Sửa Thuộc Tính Phòng</a>
                                </div>
                            ...
                            <div class="email-right-box ms-0 ms-sm-2 ms-sm-0">
                                ...
                                <div class="compose-content">
                                    <form action="{{ route('route_BackEnd_properties_Detail',$id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
