                    ...
                    <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                        ...
                        <form class="" action="{{ route('route_FrontEnd_User_Update_Profile', $user_pf->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-6 col-sm-4 control-label">Ảnh cá nhân<span class="text-danger"> *</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-6 col-sm-4 control-label">Ảnh CMND/CCCD<span class="text-danger"> *</span></label>
                                        <div class="col-md-9 col-sm-8">
                                            <div class="row">
                                                <div class="col-xs-6">
