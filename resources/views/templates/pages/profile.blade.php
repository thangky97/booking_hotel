                ...
                <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                    <div class="profile-tab-nav border-right">
                        <div class="p-4">
                            <div class="img-circle text-center mb-3">
                                <img src="{{ asset('storage/' . $user_pf->image) }}" alt=""
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="password-tab" data-toggle="pill" href="#password-res" role="tab"
                                aria-controls="password-res" aria-selected="false">
                    ...
                    <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                            ...
                            <form class="" action="{{ route('route_FrontEnd_User_Update_Profile', $user_pf->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" id="" value="" class="form-control">
                                                <option class="text-success" value="1" <?php if ($user_pf->gender == 1) : ?>selected
                                                    <?php endif ?>>Nam</option>
                                                <option class="text-danger" value="2" <?php if ($user_pf->gender == 2) : ?>selected
                                                    <?php endif ?>>Nữ</option>
                                            </select>
                                            @error('gender')
                                                <div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-6 col-sm-4 control-label">Ảnh cá nhân<span
                                            ...
                                            <div class="col-md-9 col-sm-8">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <img id="image"
                                                            src="{{ asset('storage/' . $user_pf->image) }}"
                                                            alt="your image"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-6 col-sm-4 control-label">Ảnh CMND/CCCD<span
                                                    class="text-danger"> *</span></label>
                                            <div class="col-md-9 col-sm-8">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <img id="cccd"
                                                            src="{{ asset('storage/' . $user_pf->cccd) }}"
                                                            alt="your image"
                                                            style="max-width: 200px; height:100px; margin-bottom: 10px;"
                                                            class="rounded profile-img me-4" />
                                                    </div>
                        ...
                        <div class="tab-pane fade" id="password-res" role="tabpanel" aria-labelledby="password-tab">
                            ...
                            <form class=""
                                action="{{ route('route_FrontEnd_User_Update_Password', $user_pf->id) }}" method="post"
                        ...
                        <div class="tab-pane fade" id="order" role="tabpanel" aria-labelledby="order-tab">
                            <h3 class="mb-4">Đơn đặt phòng của tôi</h3>
                            <div class="table-responsive">
                                <table
                                    class="table card-table  display mb-4 dataTablesCard booking-table table-responsive-lg "
                                    id="guestTable-all">
                                    <thead>
                                        <tr>
                                            <th>Tên</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($history as $bk_history)
                                            <tr>
                                                <td>
                                                    <p>
                                                        <a class="nav-link" id="bookingid-tab" data-toggle="pill"
                                                            href="#bookingid" role="tab" aria-controls="security"
                                                            aria-selected="false">
                                                            {{ $user_pf->name }}
                                                        </a>
                                                    </p>
                                                ...
                                                <td>
                                                    <div style="width: 100px">
                                                        <h6>
                                                            {{ date('d', strtotime($bk_history->checkin_date)) }} -
                                                            {{ date('m', strtotime($bk_history->checkin_date)) }} -
                                                            {{ date('Y', strtotime($bk_history->checkin_date)) }}
                                                        </h6>
                                                ...
                                                <td>
                                                    <div style="width: 100px">
                                                        <h6>
                                                            {{ date('d', strtotime($bk_history->checkout_date)) }} -
                                                            {{ date('m', strtotime($bk_history->checkout_date)) }} -
                                                            {{ date('Y', strtotime($bk_history->checkout_date)) }}
                                                        </h6>
                                                        {{-- <span class="fs-14">08:29 AM</span> --}}
                                                    </div>
                                                </td>
                            ...
                            <p>Mọi thắc mắc về đơn đặt phòng , quý khách vui lòng liên hệ lại đường dây nóng <i
                                    class="text-primary">0931 657 128</i> hoặc email <i
                                    class="text-primary">hotel.12zodiac@gmail.com </i>để được hỗ trợ !</p>
                        </div>
