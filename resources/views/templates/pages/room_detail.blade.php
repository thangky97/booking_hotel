...
@section('content')
    <div
        ...
        <h1 id="nd_booking_single_cpt_1_title" class="nd_booking_font_size_40 nd_booking_font_size_30_all_iphone ">
            {{ $room->name }}</h1>
        ...
        <div id="nd_booking_single_cpt_1_subtitle"
            ...
            @for ($i = 1; $i <= (int) $room->cate_room + 2; $i++)
                <img alt="" class="nd_booking_margin_right_5 nd_booking_float_left nd_booking_margin_top_5"
                    width="15"
        ...
        <div class=" nd_booking_width_100_percentage nd_booking_padding_15 nd_booking_box_sizing_border_box ">
            ...
            <rs-module-wrap id="rev_slider_5_1_wrapper" data-source="gallery"
                ...
                <rs-module id="rev_slider_5_1" style="" data-version="6.5.7">
                    <rs-slides>
                        <rs-slide style="position: absolute;" data-key="rs-11" data-title="Slide"
                            ...
                            <img src="//www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/revslider/public/assets/assets/dummy.png"
                                title="room1" width="1110" height="720" class="rev-slidebg tp-rs-img rs-lazyload"
                        ...
                        <rs-slide style="position: absolute;" data-key="rs-12" data-title="Slide"
                            ...
                            data-in="o:0;" data-out="a:false;">
                            <img src="//www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/revslider/public/assets/assets/dummy.png"
                                title="room2" width="1110" height="720" class="rev-slidebg tp-rs-img rs-lazyload"
                        ...
                        <rs-slide style="position: absolute;" data-key="rs-13" data-title="Slide"
                            ...
                            data-in="o:0;" data-out="a:false;">
                            <img src="//www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/revslider/public/assets/assets/dummy.png"
                                title="room3" width="1110" height="720" class="rev-slidebg tp-rs-img rs-lazyload"
                        ...
                        <rs-slide style="position: absolute;" data-key="rs-14" data-title="Slide"
                            ...
                            data-in="o:0;" data-out="a:false;">
                            <img src="//www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/revslider/public/assets/assets/dummy.png"
                                title="room4" width="1110" height="720" class="rev-slidebg tp-rs-img rs-lazyload"
                    ...
                    <rs-static-layers>
                        ...
                        <rs-layer id="slider-5-slide-5-layer-0" class="rs-layer-static" data-type="object" data-rsp_ch="on"
                            data-xy="x:50px;y:50px;" data-text="w:normal;" data-onslides="s:1;" data-frame_999="o:0;st:w;"
                            style="z-index:5;font-family:'Roboto';">
                        </rs-layer>

                        <rs-layer id="slider-5-slide-5-layer-1" class="rs-layer-static" data-type="shape" data-rsp_ch="on"
                            data-xy="x:c;y:c;" data-text="w:normal;" data-dim="w:100%;h:100%;" data-onslides="s:1;"
            ...
            <div id="nd_booking_single_cpt_1_basic_info" class="nd_booking_section">
                ...
                <div id="nd_booking_single_cpt_1_basic_info_night"
                    ...
                    <div class="nd_booking_section nd_booking_height_5"></div>
                    <p class="">{{ number_format($room->price) }} đ / ngày</p>
                </div>
            </div>
            <!--END basic informations-->

            <div class="nd_booking_section nd_booking_height_30"></div>
            <div class="nd_booking_section nd_booking_height_2 nd_booking_bg_grey nd_booking_single_cpt_1_divider">
            </div>
            ...
            <div id="nd_booking_single_cpt_1_services_content" class="nd_booking_section">
                <div class="nd_booking_section nd_booking_height_40"></div>
                <div class="nd_booking_section">
                    <h2 class="nd_booking_word_wrap_break_word"><span style="text-transform: capitalize;">Dịch vụ</span></h2>
                </div>
                <div class="nd_booking_section nd_booking_height_20"></div>
    ...
    <div
        ...
        <!--START FORM-->
        <form id="nd_booking_single_cpt_1_calendar" action="{{ route('route_FontEnd_BookingSearch') }}" method="POST">
            @csrf
            <div
                ...
                <div
                    ...
                    <div id="nd_booking_single_cpt_1_calendar_checkout"
                        ...
                        <input placeholder="Check Out"
                            class="nd_booking_section nd_booking_margin_top_30 nd_booking_margin_0_all_iphone nd_booking_border_width_0_important nd_booking_padding_0_important nd_booking_height_0_important"
                            type="text" name="check_out" id="nd_booking_archive_form_date_range_to" value="" />
                    ...
                    <div id="nd_booking_search_cpt_1_form_guests"
                        ...
                        <div id="nd_booking_search_guests_bg"
                            ...
                            <div class="nd_booking_section  nd_booking_box_sizing_border_box nd_booking_text_align_center">
                                ...
                                <div class="nd_booking_display_inline_flex ">
                                    ...
                                    <div
                                        class="nd_booking_float_right nd_booking_text_align_center nd_booking_margin_left_10">
                                        <div class="nd_booking_section nd_booking_height_7">
                                        </div>
                                        <div class="nd_booking_section">
                        ...
                        <input placeholder="Guests" onchange="nd_booking_sorting(1)"
                            class="nd_booking_section nd_booking_display_none" type="number" name="people"
                            id="nd_booking_archive_form_guests" min="1" value="" />
                    </div>
                    <script type="text/javascript">
                        //<![CDATA[
                        jQuery(document).ready(function() {
                    ...
                    <div id="nd_booking_single_cpt_1_calendar_btn"
                        ...
                        <div class="nd_booking_section nd_booking_height_15 nd_booking_display_none_all_iphone">
                        </div>
                        <input
            ...
            <div class="nd_booking_section">
                @foreach ($listCaterooms as $cateroom)
                    @if ($cateroom->id != $room->cate_room)
                        <div id="nd_booking_ss_rooms_5655" class="nd_booking_ss_rooms nd_booking_width_100_percentage">
                                    ...
                                    <div
                                        ...
                                        <div class="nd_booking_section">
                                            @for ($i = 1; $i <= (int) $cateroom->id + 2; $i++)
                                                <img alt=""
                                                    class="nd_booking_margin_right_5 nd_booking_float_left" width="13"
                                        ...
                                        <div class="nd_booking_section nd_booking_height_10"></div>
                                        <p class="">Chỉ từ {{ number_format($cateroom->price) }} đ</p>
                                        <div class="nd_booking_section">
                                            <a href="{{ route('route_FrontEnd_Room_RoomDetail', $cateroom->id) }}"
                                                style="background-color: #6b6978;"
                                                class="nd_options_color_white nd_booking_padding_5_10 nd_booking_font_size_10 nd_booking_letter_spacing_2 nd_booking_font_weight_bold">Xêm
                                                thêm</a>
                                        </div>
                    ...
                    <div
                        ...
                        <div class="nd_booking_position_absolute nd_booking_bottom_30">
                            ...
                            <p
                                ...
                                Với {{ number_format($room->price) }} đ</p>
                        </div>
                    </div>
                </div>
            </div>
