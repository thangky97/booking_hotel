...
<section
    class="elementor-section elementor-top-section elementor-element elementor-element-f316325 elementor-section-stretched elementor-section-boxed elementor-section-height-default elementor-section-height-default"
    data-id="f316325" data-element_type="section"
    data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;,&quot;background_background&quot;:&quot;classic&quot;}">
    <div class="elementor-container elementor-column-gap-default">
        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-a7d88b4"
            data-id="a7d88b4" data-element_type="column">
            <div class="elementor-widget-wrap elementor-element-populated">
                <div class="elementor-element elementor-element-46f0b7f elementor-widget elementor-widget-order"
                    data-id="46f0b7f" data-element_type="widget" data-widget_type="order.default">
                    <div class="elementor-widget-container">
                        ...
                        <div class="nd_booking_section">
                                ...
                                jQuery(document).ready(function() {
                                    ...
                                    jQuery(function($) {
                                        ...
                                        $("#nd_booking_search_filter_options a").on("click", function() {
                                            ...
                                            $("#nd_booking_search_filter_options a").removeClass(
                                        ...
                                        $("#nd_booking_search_filter_layout a").on("click", function() {
                                            ...
                                            $("#nd_booking_search_filter_layout a").removeClass(
                                                "nd_booking_search_filter_layout_active");
                                        ...
                                        $("#nd_booking_search_filter_options li").on("click", function() {
                                            $("#nd_booking_search_filter_options li").removeClass(
                                                "nd_booking_search_filter_options_active_parent");
                            ...
                            <style>
                                ...
                                .nd_booking_search_filter_layout_grid {
                                    background-image: url(../wp-content/plugins/nd-booking/addons/elementor/order/img/icon-grid-grey.svg);
                                }

                                .nd_booking_search_filter_layout_grid.nd_booking_search_filter_layout_active {
                                    background-image: url(../wp-content/plugins/nd-booking/addons/elementor/order/img/icon-grid-white.svg);
                                }

                                .nd_booking_search_filter_layout_list.nd_booking_search_filter_layout_active {
                                    background-image: url(../wp-content/plugins/nd-booking/addons/elementor/order/img/icon-list-white.svg);
                                }

                                .nd_booking_search_filter_layout_list {
                                    background-image: url(../wp-content/plugins/nd-booking/addons/elementor/order/img/icon-list-grey.svg);
                                }
                            </style>


                            <div id="nd_booking_el_order" class="nd_booking_section">
                                <div id="nd_booking_search_results_order_options"
                                    class="nd_booking_section nd_booking_padding_10_0 nd_booking_box_sizing_border_box nd_booking_bg_greydark nd_booking_text_align_center">
                                    <div
                                        class="nd_booking_section nd_booking_position_relative nd_booking_line_height_0">


                                        <ul id="nd_booking_search_filter_options"
                                            class="nd_booking_list_style_none nd_booking_display_inline_block nd_booking_padding_0 nd_booking_margin_0">

                                            <li id="nd_booking_el_order_price"
                                                class="nd_booking_display_inline_block nd_booking_position_relative nd_booking_padding_20 nd_booking_padding_bottom_15 nd_booking_margin_0 nd_booking_float_left">
                                                <p
                                                    class="nd_booking_font_size_12 nd_booking_padding_bottom_5 nd_booking_letter_spacing_2 nd_booking_text_transform_uppercase nd_booking_float_left nd_options_color_white">
                                                    Giá</p>
                                                <img alt=""
                                                    class="nd_booking_margin_left_10 nd_booking_float_left"
                                                    width="10"
                                                    src="{{ asset('wp-content/plugins/nd-booking/addons/elementor/order/img/icon-down-arrow-white.svg') }}">
                                                <ul
                                                    class="nd_booking_padding_top_12 nd_booking_z_index_99 nd_booking_width_160 nd_booking_list_style_none nd_booking_search_filter_options_child nd_booking_position_absolute nd_booking_left_0 nd_booking_top_50 nd_booking_display_none nd_booking_padding_0 nd_booking_margin_0 nd_booking_width_100_percentage">
                                                    <li
                                                        class="nd_booking_text_align_left nd_booking_bg_greydark_2 nd_booking_font_size_11 nd_booking_letter_spacing_2 nd_booking_text_transform_uppercase nd_booking_padding_15_20">
                                                        <a data-meta-key="nd_booking_meta_box_min_price"
                                                            data-order="ASC"
                                                            class="nd_booking_cursor_pointer nd_options_color_white">Thấp nhất</a>
                                                    </li>
                                                    <li
                                                        class="nd_booking_text_align_left nd_booking_bg_greydark nd_booking_font_size_11 nd_booking_letter_spacing_2 nd_booking_text_transform_uppercase nd_booking_padding_15_20">
                                                        <a data-meta-key="nd_booking_meta_box_min_price"
                                                            data-order="DESC"
                                                            class="nd_booking_cursor_pointer nd_options_color_white">Cao nhất</a>
                                                    </li>
                                                </ul>
                                            </li>

                                            <li id="nd_booking_el_order_size"
                                                class="nd_booking_display_inline_block nd_booking_position_relative nd_booking_padding_20 nd_booking_padding_bottom_15 nd_booking_margin_0 nd_booking_float_left">
                                                <p
                                                    class="nd_booking_font_size_12 nd_booking_padding_bottom_5 nd_booking_letter_spacing_2 nd_booking_text_transform_uppercase nd_booking_float_left nd_options_color_white">
                                                    Kích cỡ phòng</p>
                                                ...
                                                <ul
                                                    ...
                                                    <li
                                                        ...
                                                        <a data-meta-key="nd_booking_meta_box_room_size"
                                                            data-order="DESC"
                                                            class="nd_booking_cursor_pointer nd_options_color_white">Lớn
                                                            <span class="nd_booking_sorting_label_1">Phòng</span></a>
                                                    </li>
                                                    <li
                                                        class="nd_booking_text_align_left nd_booking_bg_greydark nd_booking_font_size_11 nd_booking_letter_spacing_2 nd_booking_text_transform_uppercase nd_booking_padding_15_20">
                                                        <a data-meta-key="nd_booking_meta_box_room_size"
                                                            data-order="ASC"
                                                            class="nd_booking_cursor_pointer nd_options_color_white">Nhỏ
                                                            <span class="nd_booking_sorting_label_2">Phòng</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        ...
                                        <div id="nd_booking_search_filter_layout"
                                            class="nd_booking_display_none_all_iphone">
                                            <a data-layout="1"
                                                class="nd_booking_search_filter_layout_grid nd_booking_cursor_pointer nd_booking_background_size_18 nd_booking_search_filter_layout_active nd_booking_width_18 nd_booking_height_18 nd_booking_position_absolute nd_booking_right_15 nd_booking_top_16"></a>
                                            <a data-layout="2"
                                                class="nd_booking_search_filter_layout_list nd_booking_cursor_pointer nd_booking_background_size_18 nd_booking_width_18 nd_booking_height_18 nd_booking_position_absolute nd_booking_right_53 nd_booking_top_16"></a>
                                        </div>
                            ...
                            <div class="nd_booking_section">
                                ...
                                <div id="nd_booking_search_cpt_1_sidebar"
                                    ...
                                    <form id="nd_booking_search_cpt_1_form_sidebar">
                                            ...
                                            <div id="nd_booking_search_main_bg"
                                                ...
                                                <div id="nd_booking_search_cpt_1_form_branches"
                                                    ...
                                                    <ul class="nd_booking_branch_ul_1 nd_booking_bg_greydark_2">
                                                        ...
                                                        <li class="nd_booking_branch_select_active">
                                                            <h3 class="nd_options_color_white">Tất cả chi nhánh</h3>
                                                            <img class="nd_booking_branch_ul_1_arrow" alt=""
                                                                width="12"
                                                                src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-white.svg') }}">
                                                        </li>
                                                        <li>
                                                            <h3 class="nd_options_color_white">Hotel Nam Định</h3>
                                                            <img class="nd_booking_branch_ul_1_arrow" alt=""
                                                                width="12"
                                                                src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-white.svg') }}">
                                                        </li>
                                                        ...
                                                        <li>
                                                            <h3 class="nd_options_color_white">Hotel Hà Nội</h3>
                                                            <img class="nd_booking_branch_ul_1_arrow" alt=""
                                                                width="12"
                                                                src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-white.svg') }}">
                                                        </li>
                                                        ...
                                                        <li>
                                                            <h3 class="nd_options_color_white">Hotel HCM</h3>
                                                            <img class="nd_booking_branch_ul_1_arrow" alt=""
                                                                width="12"
                                                                src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-white.svg') }}">
                                                        </li>
                                                        ...
                                                        <ul
                                                            class="nd_booking_branch_select_sub_menu nd_booking_bg_greydark_2">
                                                            <li data-id="0" data-position="0">Tất cả chi nhánh</li>
                                                            <li data-id="6243" data-position="1">Hotel Nam Định</li>
                                                            <li data-id="6213" data-position="2">Hotel Hà Nội</li>
                                                            <li data-id="6211" data-position="3">Hotel HCM</li>
                                                        </ul>
                                                    ...
                                                    <!--END ul-->
                                                    <select
                                                        class="nd_booking_display_none_important nd_booking_width_100_percentage nd_booking_bg_greydark_2_important nd_booking_border_width_0_important nd_options_color_white nd_options_first_font nd_booking_font_size_20 nd_booking_text_align_center"
                                                        onchange="nd_booking_sorting(1)"
                                                        name="nd_booking_archive_form_branches"
                                                        id="nd_booking_archive_form_branches">
                                                        <option value="0">Tất cả chi nhánh</option>
                                                        <option value="6243">Hotel Nam Định</option>
                                                        <option value="6213">Hotel Hà Nội</option>
                                                        <option value="6211">Hotel HCM</option>
                                                    </select>
                                                </div>
                                                <!--branches-->
                                                ...
                                                <div id="nd_booking_search_cpt_1_form_guests"
                                                    ...
                                                    <label class="nd_booking_display_none"
                                                        for="nd_booking_archive_form_guests">Người lớn :</label>
                                                    <input placeholder="Guests" onchange="nd_booking_sorting(1)"
                                        ...
                                        <!--max night range-->
                                        <div id="nd_booking_search_cpt_1_form_night_range"
                                            ...
                                            <div class="nd_booking_section nd_booking_height_2 nd_booking_bg_grey">
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="nd_booking_section">
                                                    <h3 class="nd_booking_float_left">Giá đêm :</h3>
                                                    <span
                                                        class="nd_booking_float_right nd_options_first_font nd_options_color_greydark nd_booking_line_height_25 nd_booking_font_size_20">$</span>
                                                    <input
                                                        class="nd_booking_float_right nd_options_first_font nd_booking_margin_right_5 nd_booking_border_width_0_important"
                                                        type="text" id="nd_booking_archive_form_max_price_for_day"
                                                        name="nd_booking_archive_form_max_price_for_day" readonly>
                                                </div>
                                        ...
                                        <!--normal service-->
                                        <div id="nd_booking_search_cpt_1_form_normal_services"
                                            class="  nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">

                                            <div
                                                class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_padding_30_15_all_iphone nd_booking_box_sizing_border_box">
                                                <h3>Dịch vụ :</h3>
                                                <img class="nd_booking_toogle_services_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer"
                                                    alt="" width="12"
                                                    src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-grey.svg') }}">
                                            ...
                                            <div
                                                ...
                                                <p
                                                    ...
                                                    <input
                                                        ...
                                                        name="nd_booking_service_id_6241" type="checkbox"
                                                        value="6241,">
                                                    Ti vi
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_service_id_6233" type="checkbox"
                                                        value="6233,">
                                                    Không hút thuốc
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_service_id_6232" type="checkbox"
                                                        value="6232,">
                                                    Phòng tắm riêng
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_service_id_6231" type="checkbox"
                                                        value="6231,">
                                                    Cho thuê xe đạp
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_service_id_6230" type="checkbox"
                                                        value="6230,">
                                                    Đồ uống
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_service_id_6228" type="checkbox"
                                                        value="6228,">
                                                    Hồ bơi
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_service_id_6229" type="checkbox"
                                                        value="6229,">
                                                    Giường cỡ King
                                                </p>
                                            ...
                                            <input type="hidden" id="nd_booking_archive_form_services"
                                                name="nd_booking_archive_form_services" value="">
                                                    ...
                                                    jQuery(function($) {
                                                        ...
                                                        $(".nd_booking_checkbox_service").change(function() {
                                                            ...
                                                            if ($(this).is(":checked")) {
                                                                ...
                                                                $("#nd_booking_archive_form_services").val(nd_booking_service_value +
                                                                    nd_booking_service_previous_value);
                                                                ...
                                                                var nd_booking_service_previous_value = $(
                                                                    "#nd_booking_archive_form_services").val();
                                                                var nd_booking_archive_form_services = nd_booking_service_previous_value
                                                                    .replace(nd_booking_service_value, "");
                                                        ...
                                                        $(".nd_booking_toogle_services_open_content").click(function() {
                                                            $(".nd_booking_toogle_services_content").slideToggle("slow", function() {
                                                                $(".nd_booking_toogle_services_open_content").css("display",
                                                                    "none");
                                                                $(".nd_booking_toogle_services_close_content").css("display",
                                                                    "block");
                                                            });
                                                        });
                                        ...
                                        <!--additional service-->
                                        <div id="nd_booking_search_cpt_1_form_extra_services"
                                            class="  nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">

                                            <div
                                                class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_padding_30_15_all_iphone nd_booking_box_sizing_border_box">
                                                <h3>Dịch vụ bổ sung :</h3>
                                                <img class="nd_booking_toogle_additional_services_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer"
                                                    alt="" width="12"
                                                    src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-grey.svg') }}">
                                                <img style="transform: rotate(180deg);"
                                                    class="nd_booking_toogle_additional_services_close_content nd_booking_display_none nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer"
                                                    alt="" width="12"
                                                    src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-grey.svg') }}">
                                            </div>

                                            <div
                                                class="nd_booking_toogle_additional_services_content nd_booking_padding_0_30 nd_booking_section nd_booking_display_none nd_booking_margin_top_10_negative nd_booking_box_sizing_border_box">
                                                <p
                                                    class="nd_booking_width_50_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_margin_0">
                                                    <input
                                                        class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_additional_service_id_7276" type="checkbox"
                                                        value="7276,">
                                                    Vệ sinh
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_additional_service_id_6225" type="checkbox"
                                                        value="6225,">
                                                    Giặt ủi
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_additional_service_id_6224" type="checkbox"
                                                        value="6224,">
                                                    Truyền hình vệ tinh
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_additional_service_id_6223" type="checkbox"
                                                        value="6223,">
                                                    Thuê ô tô
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_additional_service_id_6222" type="checkbox"
                                                        value="6222,">
                                                    Hướng biển
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_additional_service_id_6221" type="checkbox"
                                                        value="6221,">
                                                    Wifi
                                                </p>
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
                                                        name="nd_booking_additional_service_id_6220" type="checkbox"
                                                        value="6220,">
                                                    Bữa sáng
                                                </p>
                                                <div class="nd_booking_section nd_booking_height_30"></div>
                                            ...
                                            <input type="hidden" id="nd_booking_archive_form_additional_services"
                                                name="nd_booking_archive_form_additional_services" value="">
                                                ...
                                                jQuery(document).ready(function() {
                                                    ...
                                                    jQuery(function($) {
                                                        ...
                                                        $(".nd_booking_toogle_additional_services_open_content").click(function() {
                                                            $(".nd_booking_toogle_additional_services_content").slideToggle("slow",
                                                                function() {
                                        ...
                                        <!--stars-->
                                        <div id="nd_booking_search_cpt_1_form_branch_stars"
                                            class="nd_booking_width_100_percentage nd_booking_display_none nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">

                                            <div
                                                class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_box_sizing_border_box">
                                                <h3>Branch Stars :</h3>
                                                <img class="nd_booking_toogle_branch_stars_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer"
                                                    alt="" width="12"
                                                    src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-grey.svg') }}">
                                                <img style="transform: rotate(180deg);"
                                                    class="nd_booking_toogle_branch_stars_close_content nd_booking_display_none nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer"
                                                    alt="" width="12"
                                                    src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-down-arrow-grey.svg') }}">
                                            </div>

                                            <div
                                                class="nd_booking_toogle_branch_stars_content nd_booking_padding_0_30 nd_booking_section nd_booking_display_none nd_booking_box_sizing_border_box">

                                                <p
                                                    class="nd_booking_width_100_percentage nd_booking_float_left nd_booking_margin_0">
                                                    <input
                                                        class="nd_booking_checkbox_branch_stars nd_booking_width_25 nd_booking_margin_right_5 nd_booking_float_left nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_1"
                                                        name="nd_booking_checkbox_branch_star_5" type="checkbox"
                                                        value="5,">
                                                    <img alt=""
                                                        class="nd_booking_margin_right_5 nd_booking_float_left"
                                                        width="12"
                                                        src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-grey.svg') }}">
                                                    <img alt=""
                                                        class="nd_booking_margin_right_5 nd_booking_float_left"
                                                        width="12"
                                                        src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-grey.svg') }}">
                                                ...
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_branch_stars nd_booking_width_25 nd_booking_margin_right_5 nd_booking_float_left nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_1"
                                                        name="nd_booking_checkbox_branch_star_4" type="checkbox"
                                                        value="4,">
                                                    <img alt=""
                                                        class="nd_booking_margin_right_5 nd_booking_float_left"
                                                        width="12"
                                                ...
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_branch_stars nd_booking_width_25 nd_booking_margin_right_5 nd_booking_float_left nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_1"
                                                        name="nd_booking_checkbox_branch_star_3" type="checkbox"
                                                        value="3,">
                                                    <img alt=""
                                                        class="nd_booking_margin_right_5 nd_booking_float_left"
                                                        width="12"
                                                ...
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_branch_stars nd_booking_width_25 nd_booking_margin_right_5 nd_booking_float_left nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_1"
                                                        name="nd_booking_checkbox_branch_star_2" type="checkbox"
                                                        value="2,">
                                                    <img alt=""
                                                        class="nd_booking_margin_right_5 nd_booking_float_left"
                                                        width="12"
                                                ...
                                                <p
                                                    ...
                                                    <input
                                                        class="nd_booking_checkbox_branch_stars nd_booking_width_25 nd_booking_margin_right_5 nd_booking_float_left nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_1"
                                                        name="nd_booking_checkbox_branch_star_1" type="checkbox"
                                                        value="1,">
                                                    <img alt=""
                                                        class="nd_booking_margin_right_5 nd_booking_float_left"
                                                        width="12"
                                            ...
                                            <input type="hidden" id="nd_booking_archive_form_branch_stars"
                                                name="nd_booking_archive_form_branch_stars" value="">
                                                    ...
                                                    jQuery(function($) {
                                                        ...
                                                        $(".nd_booking_checkbox_branch_stars").change(function() {
                                                            ...
                                                            if ($(this).is(":checked")) {
                                                                ...
                                                                var nd_booking_branch_stars_previous_value = $(
                                                                    "#nd_booking_archive_form_branch_stars").val();
                                                                $("#nd_booking_archive_form_branch_stars").val(
                                                                    nd_booking_branch_stars_value +
                                                                    nd_booking_branch_stars_previous_value);
                                                                ...
                                                                var nd_booking_branch_stars_previous_value = $(
                                                                    "#nd_booking_archive_form_branch_stars").val();
                                                                var nd_booking_archive_form_branch_stars =
                                                                    nd_booking_branch_stars_previous_value.replace(
                                                                        nd_booking_branch_stars_value, "");
                                                        ...
                                                        $(".nd_booking_toogle_branch_stars_open_content").click(function() {
                                                            $(".nd_booking_toogle_branch_stars_content").slideToggle("slow", function() {
                                                                $(".nd_booking_toogle_branch_stars_open_content").css("display",
                                                                    "none");
                                                                $(".nd_booking_toogle_branch_stars_close_content").css("display",
                                                                    "block");
                                                            });
                                                        });
                                    ...
                                    <div id="nd_booking_archive_search_masonry_container"
                                        ...
                                        <div id="nd_booking_content_result" class="nd_booking_section">
                                            ...
                                            <div class="nd_booking_section nd_booking_masonry_content">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="nd_options_color_white nd_booking_font_size_10 nd_booking_line_height_10 nd_booking_letter_spacing_2 nd_booking_padding_3_5 nd_booking_padding_top_5 nd_booking_top_10 nd_booking_position_absolute nd_booking_right_10 nd_booking_bg_color_3">THIS
                                                                    Phòng cuối cùng với mức giá này</span>

                                                                <img alt="" class="nd_booking_section"
                                                                    src="{{ asset('wp-content/uploads/sites/4/2022/05/room1-1024x664.jpg') }}">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Hotel Hà Nội</p><img alt=""
                                                                            class="nd_booking_margin_right_5 nd_booking_float_left"
                                                                            width="10"
                                                                            src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg') }}"><img
                                                                            alt=""
                                                                            class="nd_booking_margin_right_5 nd_booking_float_left"
                                                                            width="10"
                                                                            src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg') }}"><img
                                                                            ...
                                                                            class="nd_booking_margin_right_5 nd_booking_float_left"
                                                                            width="10"
                                                                            src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg') }}">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="../rooms/small-room/index.html">
                                                                    <h1>Small Room</h1>
                                                                </a>
                                                                ...
                                                                <div class="nd_booking_section">
                                                                    <div
                                                                        ...
                                                                        <img alt=""
                                                                            ...
                                                                            width="23"
                                                                            src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-user-grey.svg') }}">
                                                                        <p
                                                                        ...
                                                                        <img alt=""
                                                                            ...
                                                                            width="20"
                                                                            src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-plan-grey.svg') }}">
                                                                        <p
                                                                            class="  nd_booking_display_table_cell nd_booking_vertical_align_middle nd_booking_font_size_12 nd_booking_line_height_26">
                                                                            15 ft</p>
                                                                    </div>
                                                                ...
                                                                <form id="nd_booking_book_room_5649" method="post"
                                                                    ...
                                                                    {{-- <input
                                                                        style=" border:2px solid #6b6978; color:#6b6978;"
                                                                        ...
                                                                        type="submit" value="Đặt phòng  56 $"> --}}
                                                                        <a href="booking">Đặt phòng  56 $</a>
                                                                </form>
                                                                <!--START all info-->
                                                                <style>
                                                                    .nd_booking_info_btn {
                                                                ...
                                                                <div style="background-color:#6b6978"
                                                                    class="nd_booking_info_btn  nd_booking_display_none_responsive">

                                                                    <img class="nd_booking_info_btn_image"
                                                                        alt=""
                                                                        src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-info.png') }}">

                                                                    <!--START popup-->
                                                                    <div class="nd_booking_info_content">
                                                                        <div
                                                                            class="nd_booking_info_table nd_booking_bg_greydark">

                                                                            <table>

                                                                                <tr
                                                                                    class="nd_booking_info_table_first nd_booking_bg_greydark_2">
                                                                                    <td>NIGHT</td>
                                                                                    <td>PRICE</td>
                                                                                    <td>GUEST</td>
                                                                                    <td>TOTAL</td>
                                                                                ...
                                                                                <tr
                                                                                    class="nd_booking_info_table_middle">
                                                                                    <td>16 Feb</td>
                                                                                    <td>56 $</td>
                                                                                    <td>1</td>
                                                                                    <td>56 $</td>
                                                                            ...
                                                                            <div
                                                                                class="nd_booking_info_table_triangle">
                                                                            </div>
                                                                ...
                                                                <a title="Swimming Pool"
                                                                    class="nd_booking_tooltip_jquery nd_booking_float_left"><img
                                                                        ...
                                                                        width="23" height="23"
                                                                        src="{{ asset('../hotel/wp-content/uploads/sites/2/2022/04/swmming-pool.png') }}"></a>
                                                                ...
                                                                <a title="Television"
                                                                    class="nd_booking_tooltip_jquery nd_booking_float_left"><img
                                                                        ...
                                                                        class="nd_booking_margin_right_15 nd_booking_float_left"
                                                                        width="23" height="23"
                                                                        src="{{ asset('../hotel/wp-content/uploads/sites/2/2022/04/television.png') }}"></a>
                                                                ...
                                                                <a title="No Smoking"
                                                                    class="nd_booking_tooltip_jquery nd_booking_float_left"><img
                                                                        ...
                                                                        class="nd_booking_margin_right_15 nd_booking_float_left"
                                                                        width="23" height="23"
                                                                        src="{{ asset('../hotel/wp-content/uploads/sites/2/2022/04/no-smoking.png') }}"></a>

                                                                <a title="Private Bathroom"
                                                                    class="nd_booking_tooltip_jquery nd_booking_float_left"><img
                                                                        loading="lazy" alt="Private Bathroom"
                                                                        class="nd_booking_margin_right_15 nd_booking_float_left"
                                                                        width="23" height="23"
                                                                        src="{{ asset('../hotel/wp-content/uploads/sites/2/2022/04/private-bathroom.png') }}"></a>
                                                                ...
                                                                <a href="../rooms/small-room/index.html"
                                                                    ...
                                                                    <span
                                                                        class="nd_booking_float_left nd_booking_font_size_11 nd_booking_letter_spacing_2">FULL
                                                                        INFO</span>
                                                                    <img alt=""
                                                                        class="nd_booking_margin_left_5 nd_booking_float_left"
                                                                        width="10"
                                                                        src="{{ asset('wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-right-arrow-grey.svg') }}">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="nd_options_color_white nd_booking_font_size_10 nd_booking_line_height_10 nd_booking_letter_spacing_2 nd_booking_padding_3_5 nd_booking_top_10 nd_booking_padding_top_5 nd_booking_position_absolute nd_booking_right_10 nd_booking_bg_color_3">ONLY
                                                                    2 ROOM LEFT AT THIS PRICE</span>

                                                                <img alt="" class="nd_booking_section"
                                                                    src="{{ asset('wp-content/uploads/sites/4/2022/05/room2-1024x664.jpg') }}">
                                                            ...
                                                            <div
                                                                class="nd_booking_section nd_booking_padding_30 nd_booking_box_sizing_border_box">
                                                                <a href="../rooms/room-with-view/index.html">
                                                                ...
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing
                                                                    elit. Integer vel molestie nisl. Duis ac mi leo.</p>
                                                                <div class="nd_booking_section nd_booking_height_20">
                                                                </div>
                                                                <form id="nd_booking_book_room_5654" method="post"
                                                                    action="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/booking-page/">
                                                                    ...
                                                                    <input
                                                                        style=" border:2px solid #444444; color:#444444;"
                                                                        class=" nd_booking_float_left nd_booking_padding_15_30_important nd_options_second_font_important nd_booking_border_radius_0_important nd_booking_background_color_transparent_important nd_booking_cursor_pointer nd_booking_display_inline_block nd_booking_font_size_11 nd_booking_font_weight_bold nd_booking_letter_spacing_2  "
                                                                        type="submit" value="BOOK NOW FOR 76 $">
                                                                </form>
                                                                <!--START all info-->
                                                                <style>
                                                                    .nd_booking_info_btn {
                                                                ...
                                                                <a title="Bike Rental"
                                                                    class="nd_booking_tooltip_jquery nd_booking_float_left"><img
                                                                        loading="lazy" alt="Bike Rental"
                                                                        class="nd_booking_margin_right_15 nd_booking_float_left"
                                                                        width="23" height="23"
                                                                        src="{{ asset('hotel/wp-content/uploads/sites/2/2022/04/bike-rental.png') }}"></a>

                                                                <a title="Welcome Drink"
                                                                    class="nd_booking_tooltip_jquery nd_booking_float_left"><img
                                                                        loading="lazy" alt="Welcome Drink"
                                                                        class="nd_booking_margin_right_15 nd_booking_float_left"
                                                                        width="23" height="23"
                                                                        src="{{ asset('hotel/wp-content/uploads/sites/2/2022/04/welcome-drink.png') }}"></a>

                                                                <a title="King Beds"
                                                                    class="nd_booking_tooltip_jquery nd_booking_float_left"><img
                                                                        loading="lazy" alt="King Beds"
                                                                        class="nd_booking_margin_right_15 nd_booking_float_left"
                                                                        width="23" height="23"
                                                                        src="{{ asset('hotel/wp-content/uploads/sites/2/2022/04/king-beds.png') }}"></a>
                                                ...
                                                <div id="nd_booking_archive_cpt_1_single_5655"
                                                    class="nd_booking_masonry_item nd_booking_width_50_percentage nd_booking_width_100_percentage_responsive">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class='nd_options_color_white nd_booking_font_size_10 nd_booking_line_height_10 nd_booking_letter_spacing_2 nd_booking_padding_3_5 nd_booking_padding_top_5 nd_booking_top_10 nd_booking_position_absolute nd_booking_right_10 nd_booking_bg_greydark'>MINIMUM
                                                                    BOOKING DAYS : 2</span>



                                                                <img alt="" class="nd_booking_section"
                                                                    src="{{ asset('wp-content/uploads/sites/4/2022/05/room3-1024x664.jpg') }}">
                                                ...
                                                <div id="nd_booking_archive_cpt_1_single_5656"
                                                    class="nd_booking_masonry_item nd_booking_width_50_percentage nd_booking_width_100_percentage_responsive">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class='nd_options_color_white nd_booking_font_size_10 nd_booking_line_height_10 nd_booking_letter_spacing_2 nd_booking_padding_3_5 nd_booking_padding_top_5 nd_booking_top_10 nd_booking_position_absolute nd_booking_right_10 nd_booking_bg_yellow'>NOT
                                                                    AVAILABLE</span>



                                                                <img alt="" class="nd_booking_section"
                                                                    src="{{ asset('wp-content/uploads/sites/4/2022/05/room4-1024x664.jpg') }}">
                                            ...
                                            <div id="nd_booking_btn_pagination_content"
                                                class="nd_booking_section nd_booking_margin_top_20">

                                                <div id="nd_booking_btn_pagination"
                                                    class="nd_booking_section nd_booking_text_align_center">

                                                    <div
                                                        class=" nd_booking_btn_pagination_active nd_booking_display_inline_block nd_booking_bg_greydark nd_booking_margin_0_10">
                                                        <a class="nd_booking_display_inline_block nd_booking_second_font nd_options_color_white nd_booking_padding_10_15 nd_booking_cursor_pointer nd_booking_font_size_11"
                                                            onclick="nd_booking_sorting(1)">
                                                            1
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div
                                                        class="  nd_booking_display_inline_block nd_booking_bg_greydark nd_booking_margin_0_10">
                                                        <a class="nd_booking_display_inline_block nd_booking_second_font nd_options_color_white nd_booking_padding_10_15 nd_booking_cursor_pointer nd_booking_font_size_11"
                                                            onclick="nd_booking_sorting(2)">
                                                            2
                                                        </a>
                                                    </div>
