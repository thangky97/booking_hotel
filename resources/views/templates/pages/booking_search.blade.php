                  ...
                  <div class="elementor-element elementor-element-46f0b7f elementor-widget elementor-widget-order" data-id="46f0b7f" data-element_type="widget" data-widget_type="order.default">
                    <div class="elementor-widget-container">
                      ...
                      <div class="nd_booking_section">
                        ...
                        <style>
                          .nd_booking_search_filter_options_active {
                            color: #fff !important;
                          }

                          #nd_booking_search_filter_options li.nd_booking_search_filter_options_active_parent p {
                            color: #fff !important;
                            border-bottom: 2px solid #878787;
                          }

                          #nd_booking_search_filter_options li:hover .nd_booking_search_filter_options_child {
                            display: block;
                          }

                          .nd_booking_search_filter_layout_grid {
                            background-image: url(http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/addons/elementor/order/layout/../img/icon-grid-grey.svg);
                          }

                          .nd_booking_search_filter_layout_grid.nd_booking_search_filter_layout_active {
                            background-image: url(http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/addons/elementor/order/layout/../img/icon-grid-white.svg);
                          }

                          .nd_booking_search_filter_layout_list.nd_booking_search_filter_layout_active {
                            background-image: url(http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/addons/elementor/order/layout/../img/icon-list-white.svg);
                          }

                          .nd_booking_search_filter_layout_list {
                            background-image: url(http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/addons/elementor/order/layout/../img/icon-list-grey.svg);
                          }
                        </style>
                                    ...
                                    <div class="nd_booking_section nd_booking_padding_15 nd_booking_box_sizing_border_box">
                                      ...
                                      <div class="nd_booking_section nd_booking_border_1_solid_grey nd_booking_bg_white">
                                        ...
                                        <div class="nd_booking_section nd_booking_position_relative">
                                          ...
                                          <span class="nd_options_color_white nd_booking_font_size_10 nd_booking_line_height_10 nd_booking_letter_spacing_2 nd_booking_padding_3_5 nd_booking_padding_top_5 nd_booking_top_10 nd_booking_position_absolute nd_booking_right_10 nd_booking_bg_color_3">Tầng {{$v_room->floor}}</span>

                                          <img alt="" class="nd_booking_section" src="{{asset("storage/".$v_room->images)}}">

                                          <div class="nd_booking_bg_greydark_alpha_gradient_3 nd_booking_position_absolute nd_booking_left_0 nd_booking_height_100_percentage nd_booking_width_100_percentage nd_booking_padding_30 nd_booking_box_sizing_border_box">
                                            <div class="nd_booking_position_absolute nd_booking_bottom_20">
                                              <p class="nd_options_color_white nd_booking_margin_right_10 nd_booking_float_left nd_booking_font_size_11 nd_booking_letter_spacing_2 nd_booking_text_transform_uppercase">@foreach ($loai_phong as $cate)
                                                @if($v_room->cate_room==$cate->id)
                                                {{ $cate->name}}
                                                @endif
                                                @endforeach
                                              </p><img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="10" src="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg"><img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="10" src="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg"><img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="10" src="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg"><img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="10" src="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg"><img alt="" class="nd_booking_margin_right_5 nd_booking_float_left" width="10" src="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/wp-content/plugins/nd-booking/inc/shortcodes/include/search-results/icon-star-full-white.svg">
                                            </div>
                                          </div>
                                        ...
                                        <div class="nd_booking_section nd_booking_padding_30 nd_booking_box_sizing_border_box">
                                          ...
                                          <div class="nd_booking_section">
                                            <div class="nd_booking_display_table nd_booking_float_left">
                                              ...
                                              <p class="  nd_booking_display_table_cell nd_booking_vertical_align_middle nd_booking_font_size_12 nd_booking_line_height_26">{{$v_room->adult+$v_room->childrend}} Người</p>
                                              ...
                                              <p class="  nd_booking_display_table_cell nd_booking_vertical_align_middle nd_booking_font_size_12 nd_booking_line_height_26">{{$v_room->bed}} Giường</p>
                                            </div>
                                          </div>

                                          <div class="nd_booking_section nd_booking_height_20"></div>
                                          <p>{{$v_room->description}}</p>
                                          <div class="nd_booking_section nd_booking_height_20"></div>
                                          <form id="nd_booking_book_room_5649" method="post" action="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/booking-page/">
                                            ...
                                            <input style=" border:2px solid #6b6978; color:#6b6978;" class=" nd_booking_float_left nd_booking_padding_15_30_important nd_options_second_font_important nd_booking_border_radius_0_important nd_booking_background_color_transparent_important nd_booking_cursor_pointer nd_booking_display_inline_block nd_booking_font_size_11 nd_booking_font_weight_bold nd_booking_letter_spacing_2  " type="submit" value="Đặt phòng ngay  $">
                                          </form>
                                          <!--START all info-->
                                          <style>
                                            .nd_booking_info_btn {
                                              ...
                                              <div class="nd_booking_info_table nd_booking_bg_greydark">
                                                ...
                                                <table>
                                                  ...
                                                  <tr class="nd_booking_info_table_middle">
                                                    ...
                                                    <td>{{$v_room->adult+$v_room->childrend}}</td>
                                                    <td>@foreach ($loai_phong as $cate)
                                                      @if($v_room->cate_room==$cate->id)
                                                      {{ $cate->price}}$
                                                      @endif
                                                      @endforeach
                                          ...
                                          <a href="http://www.nicdarkthemes.com/themes/hotel-booking/wp/demo/apartments/rooms/small-room/" class="nd_booking_margin_top_7 nd_booking_margin_top_20_all_iphone nd_booking_width_100_percentage_all_iphone nd_booking_float_right nd_booking_float_left_all_iphone nd_booking_display_inline_block nd_booking_text_align_center nd_booking_box_sizing_border_box nd_booking_font_size_12">
                                            <span class="nd_booking_float_left nd_booking_font_size_11 nd_booking_letter_spacing_2">Thông Tin Phòng</span>
