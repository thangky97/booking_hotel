                                                        ...
                                                        <div class="nd_booking_section">
                                                                    ...
                                                                    <div id="nd_booking_book_main_bg"
                                                                            ...
                                                                            <div id="nd_booking_book_bg_check_in"
                                                                                ...
                                                                                <h6
                                                                                    ...
                                                                                    <i>
                                                                                        @if (date('m', $checkin) == 1)
                                                                                            Jan
                                                                                        @elseif(date('m', $checkin) == 2)
                                                                                            Feb
                                                                                        @elseif(date('m', $checkin) == 3)
                                                                                            Mar
                                                                                        @elseif(date('m', $checkin) == 4)
                                                                                            Apr
                                                                                        @elseif(date('m', $checkin) == 5)
                                                                                            May
                                                                                        @elseif(date('m', $checkin) == 6)
                                                                                            Jun
                                                                                        @elseif(date('m', $checkin) == 7)
                                                                                            Jul
                                                                                        @elseif(date('m', $checkin) == 8)
                                                                                            Aug
                                                                                        @elseif(date('m', $checkin) == 9)
                                                                                            Sep
                                                                                        @elseif(date('m', $checkin) == 10)
                                                                                            Oct
                                                                                        @elseif(date('m', $checkin) == 11)
                                                                                            Nov
                                                                                        @elseif(date('m', $checkin) == 12)
                                                                                            Dec
                                                                                        @endif
                                                                                        , 2023
                                                                                    </i>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div id="nd_booking_book_bg_check_out"
                                                                                ...
                                                                                <h6
                                                                                    class="nd_options_color_white nd_booking_font_size_11">
                                                                                    <i>
                                                                                        @if (date('m', $checkout) == 1)
                                                                                            Jan
                                                                                        @elseif(date('m', $checkout) == 2)
                                                                                            Feb
                                                                                        @elseif(date('m', $checkout) == 3)
                                                                                            Mar
                                                                                        @elseif(date('m', $checkout) == 4)
                                                                                            Apr
                                                                                        @elseif(date('m', $checkout) == 5)
                                                                                            May
                                                                                        @elseif(date('m', $checkout) == 6)
                                                                                            Jun
                                                                                        @elseif(date('m', $checkout) == 7)
                                                                                            Jul
                                                                                        @elseif(date('m', $checkout) == 8)
                                                                                            Aug
                                                                                        @elseif(date('m', $checkout) == 9)
                                                                                            Sep
                                                                                        @elseif(date('m', $checkout) == 10)
                                                                                            Oct
                                                                                        @elseif(date('m', $checkout) == 11)
                                                                                            Nov
                                                                                        @elseif(date('m', $checkout) == 12)
                                                                                            Dec
                                                                                        @endif
                                                                                        , 2023
                                                                                    </i>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div id="nd_booking_book_bg_guests"
                                                                                class="nd_booking_section nd_booking_bg_greydark_2 nd_booking_padding_20 nd_booking_box_sizing_border_box nd_booking_text_align_center">
                                                                                <h1 class=" nd_options_color_white">
                                                                                    {{ $peoples }}</h1>
                                                                                <div
                                                            ...
                                                            <div
                                                                ...
                                                                @if (Session::get('user_profile') == null)
                                                                    <p class="nd_options_color_black">Bạn đang đặt phòng với
                                                                        tư cách là khách, hãy <a target="_blank"
                                                                            class="nd_options_color_red nd_booking_border_bottom_1_solid_white"
                                                                            href="{{ route('getSignin') }}"
                                                                            style="font-weight: bold;text-decoration:underline;">ĐĂNG
                                                                            NHẬP</a>
                                                                        hoặc <a target="_blank"
                                                                            class="nd_options_color_red nd_booking_border_bottom_1_solid_white"
                                                                            href="{{ route('getSignup') }}"
                                                                            style="font-weight: bold;text-decoration:underline;">TẠO
                                                                            TÀI KHOẢN</a>
                                                                        nếu bạn muốn lưu đặt phòng của bạn trên tài khoản
                                                                        của bạn</p>
                                                                @endif
                                                                <hr style="margin: 30px 0 30px 0">
                                                                <div
                                                                    class="nd_booking_section nd_booking_margin_top_50_responsive">
                                                                    <h1>Dịch vụ có sẵn :</h1>
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    <span style="color: #fff"
                                                                                        class="nd_options_color_greydark nd_booking_font_weight_bolder nd_booking_float_left_all_iphone">{{ $item->name }}</span>
                                                                                </span>
                                                                                <span
                                                                                    class="nd_booking_float_left_all_iphone nd_booking_margin_bottom_20_all_iphone">Free</span>
                                                                            </p>
                                                                        @endif
                                                                    @endforeach
                                                                    ...
                                                                    <form method="post"
                                                                        ...
                                                                        <div class="custom-table-room">
                                                                            <table id="customers">
                                                                                ...
                                                                                <tbody>
                                                                                    <script>
                                                                                        localStorage.setItem('priceSum', 0);
                                                                                    </script>
                                                                                    <?php $i = 1;
                                                                                    $arrRoomId = []; ?>
                                                                                    @foreach ($listRooms as $index => $item)
                                                                                        <?php $roomId = [$index => $item->id];
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><img class="me-3"
                                                                                                    ...
                                                                                                    height="100px"></td>
                                                                                            <td>{{ $item->adult }}</td>
                                                                                            <td>{{ $item->price }}đ/Ngày
                                                                                            </td>
                                                                                            <script>
                                                                                                localStorage.setItem('priceRoom_{{ $item->id }}', {{ $item->price }});
                                                                                                localStorage.setItem('priceSum', Number(localStorage.getItem('priceSum')) + Number(localStorage.getItem(
                                                                                                    'priceRoom_{{ $item->id }}')));
                                                                                            </script>
                                                                                            <td class="special-box"
                                                                                                style="width: 250px">
                                                                                                <ul style="display: flex;flex-direction: column; flex-wrap: wrap;align-content: flex-start;margin-top: 0px;padding-left: 0px"
                                                                                                    class="special-box-ul">
                                                                                                    @foreach ($listService as $service)
                                                                                                        <li><input
                                                                                                                type="checkbox"
                                                                                                                id="checkbox_{{ $item->id }}_{{ $service->id }}"
                                                                                                                name="service_id_{{ $i - 1 }}[]"
                                                                                            ...
                                                                                            <td
                                                                                                id="showpice_{{ $item->id }}">
                                                                                                {{ $item->price }}đ</td>
                                                                                            <script>
                                                                                                function showpice{{ $item->id }}() {
                                                                                                    document.getElementById('showpice_{{ $item->id }}').innerHTML = localStorage.getItem(
                                                                                                        'priceRoom_{{ $item->id }}') + ' đ';
                                                                                                }
                                                                                            </script>
                                                                                        </tr>
                                                                                    @endforeach
                                                                            ...
                                                                            <div id="showpricesum" style="color: #0c85d0;font-size: 20px"></div>
                                                                            <script>
                                                                                function showpicesum() {
                                                                                    document.getElementById('showpricesum').innerHTML = 'Tổng tiền: ' + localStorage.getItem('priceSum') + ' đ';
                                                                                }
                                                                            </script>
                                                                        </div>
                                                                        <hr style="margin: 30px 0 30px 0">
                                                                        <input name="checkin_date"
                                                                            value="{{ $checkin }}" hidden>
                                                                        <input name="checkout_date"
                                                                            value="{{ $checkout }}" hidden>
                                                                        <input name="people" value="{{ $peoples }}"
                                                                            hidden>
                                                                        <input name="room_id"
                                                                            value="{{ implode(',', $arrRoomId) }}" hidden>
                                                                        <h1 style="margin: 40px 0 30px 0">Nhập thông tin
                                                                            khách hàng</h1>
                                                                            ...
                                                                            @foreach (Session::get('user_profile') as $profile)
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <select name="gender"
                                                                                        ...
                                                                                        <option value="1"
                                                                                            <?php if ($profile['gender'] == 1) : ?>selected
                                                                                            <?php endif ?>>Nữ</option>
                                                                                        <option value="2"
                                                                                            <?php if ($profile['gender'] == 2) : ?>selected
                                                                                ...
                                                                                <div id="nd_booking_booking_form_coupon_container"
                                                                                    ...
                                                                                    <p>Căn cước công dân/ Chứng minh thư <span style="color: red">*</span>
                                                                                    </p>
                                                                                    <div
                                                                                        class="nicdark_section nicdark_height_5">
                                                                                    </div>
                                                                                    <img id="cccd"
                                                                                        src="{{ asset('storage/' . $profile['cccd']) }}"
                                                                                        alt="your image"
                                                                        ...
                                                                        @if (!isset($profile))
                                                                            ...
                                                                            <div id="nd_booking_booking_form_coupon_container"
                                                                                class="nd_booking_width_100_percentage  nd_booking_box_sizing_border_box nd_booking_float_left">
                                                                                <p>Căn cước công dân/ Chứng minh thư <span style="color: red">*</span></p>
                                                                                <div
                                                                                    class="nicdark_section nicdark_height_5">
                                                                                </div>
                                                                                <input class="nd_booking_section"
