                            ...
                            <div class=" px-3 u-header__login-form dropdown-connector-xl u-header__topbar-divider">
                                <div id="" class=" py-0 mt-0" aria-labelledby="signUpDropdownInvoker" style="min-width: 500px;">
                                    <div class="card rounded-xs">
                                        <form class="js-validate" novalidate="novalidate" action="{{ route('postSignup') }}" method="post">
                                            @csrf  
                                                        ...
                                                        <div class="tab-pane fade active show" id="pills-one-code-sample" role="tabpanel" aria-labelledby="pills-one-code-sample-tab">
                                                            ...
                                                            <div class="form-group pb-1">
                                                                <div class="js-form-message js-focus-state border border-width-2 border-color-8 rounded-sm">
                                                                    ...
                                                                    <div class="input-group input-group-tranparent input-group-borderless input-group-radiusless">
                                                                        <input type="text" class="form-control" value="@isset($request['name']){{ $request['name'] }}@endisset" name="name" id="uname" placeholder="Nhập tên..." aria-label="User Name" aria-describedby="username" required="" data-msg="Please enter a valid user name." data-error-class="u-has-error" data-success-class="u-has-success">
                                                            ...
                                                            <div class="form-group pb-1">
                                                                <div class="js-form-message js-focus-state border border-width-2 border-color-8 rounded-sm">
                                                                    ...
                                                                    <div class="input-group input-group-tranparent input-group-borderless input-group-radiusless">
                                                                        <input type="email" class="form-control" value="@isset($request['email']){{ $request['email'] }}@endisset" name="email" id="signupSrEmail" placeholder="Nhập email..." aria-label="Email" aria-describedby="signupEmail" required="" data-msg="Please enter a valid email address." data-error-class="u-has-error" data-success-class="u-has-success">
                                                                        <div class="input-group-append">
                                                            ...
                                                            <div class="form-group pb-1">
                                                                <div class="js-form-message js-focus-state border border-width-2 border-color-8 rounded-sm">
                                                                    <label class="sr-only" for="signupSrPassword">Mật khẩu</label>
                                                                    <div class="input-group input-group-tranparent input-group-borderless input-group-radiusless">
                                                                        <input type="password" class="form-control" value="@isset($request['password']){{ $request['password'] }}@endisset" name="password" id="signupSrPassword" placeholder="Nhập mật khẩu..." aria-label="Password" aria-describedby="signupPassword" required="" data-msg="Your password is invalid. Please try again." data-error-class="u-has-error" data-success-class="u-has-success">
                                                            ...
                                                            <div class="form-group pb-1">
                                                                <div class="js-form-message js-focus-state border border-width-2 border-color-8 rounded-sm">
                                                                    ...
                                                                    <div class="input-group input-group-tranparent input-group-borderless input-group-radiusless">
                                                                        <input type="number" class="form-control" value="@isset($request['phone']){{ $request['phone'] }}@endisset" name="phone" id="signupSrPassword" placeholder="Nhập số điện thoại..." aria-label="Password" aria-describedby="signupPassword" required="" >
                                                                        <div class="input-group-prepend">
                                                                            <span class="input-group-text" id="signupPassword">
                                                            ...
                                                            <!-- End Form Group -->
                                                            <div class="">
                                                                <button type="submit" class="btn btn-md btn-block btn-blue-1 rounded-xs font-weight-bold transition-3d-hover">Đăng ký</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-footer p-0">
                                                    ...
                                                    <div class="card-footer__bottom p-4 text-center font-size-14">
                                                        ...
                                                        <a class="font-weight-bold" href="{{ route('getSignin') }}">Đăng nhập</a>
                                                    </div>
                                                </div>
                                        </form>
                                    </div>
