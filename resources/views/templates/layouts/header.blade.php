                                    ...
                                    <ul class="elementor-icon-list-items elementor-inline-items">
                                        <li class="elementor-icon-list-item elementor-inline-item">
                                            <a href="#">
                                                ...
                                                <span class="elementor-icon-list-text">Các lựa chọn thanh toán</span>
                                            </a>
                                        </li>
                                        <li class="elementor-icon-list-item elementor-inline-item">
                                            <a href="#">
                                                    ...
                                                    <div class="elementor-shortcode">
                                                        ...
                                                        <div style="margin:15px 10px;" id="nd_options_alert_1" class="  nd_options_position_relative nd_options_float_right ">
                                                            ...
                                                            <div id="nd_options_alert_1_icon" class="nd_options_position_relative">
                                                                <p class="nd_options_position_absolute nd_options_color_white nd_options_font_size_10" style="line-height: 10px; padding: 2px 3px; left: 13px; top: -7px; background-color:#6B6978; ">
                                                                    4</p>
                                                                <img alt="" class="nd_options_float_left" width="20" src="wp-content/uploads/sites/4/2022/05/icn5.png">
                                                            </div>
                                                            ...
                                                            <div id="nd_options_alert_1_messages" class="nd_options_display_none">
                                                                ...
                                                                <div style="background-color:#fff;" class="nd_options_box_sizing_border_box nd_options_padding_10 nd_options_section nd_options_text_align_left">
                                                                    ...
                                                                    <div class="  nd_options_section nd_options_position_relative nd_options_box_sizing_border_box nd_options_padding_10 nd_options_min_height_70">
                                                                        <img alt="" class="nd_options_position_absolute" width="50" src="../hotel/wp-content/uploads/sites/2/2022/03/square-4.jpg">
                                                                    ...
                                                                    <div class="  nd_options_section nd_options_position_relative nd_options_box_sizing_border_box nd_options_padding_10 nd_options_min_height_70">
                                                                        <img alt="" class="nd_options_position_absolute" width="50" src="../hotel/wp-content/uploads/sites/2/2022/03/square-6.jpg">
                                                                        <div class="nd_options_section nd_options_padding_left_70 nd_options_box_sizing_border_box">
                                                                            <div class="nd_options_section nd_options_height_10">
                                                                            </div><a href="#">
                                                                                <h6>Multi Purpose</h6>
                                                                    ...
                                                                    <div class="  nd_options_section nd_options_position_relative nd_options_box_sizing_border_box nd_options_padding_10 nd_options_min_height_70">
                                                                        <img alt="" class="nd_options_position_absolute" width="50" src="../hotel/wp-content/uploads/sites/2/2022/03/square-2.jpg">
                                                                        <div class="nd_options_section nd_options_padding_left_70 nd_options_box_sizing_border_box">
                                                                            <div class="nd_options_section nd_options_height_10">
                                                                            </div><a href="#">
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-shortcode">
                                                        ...
                                                        <div id="" style="background-color:#6B6978;" class="  nd_options_display_table nd_options_float_right nd_options_padding_10_20 nd_options_margin_right_15">
                                                            <a href="booking-account/index.html"><img alt="" class="nd_options_margin_right_10 nd_options_display_table_cell nd_options_vertical_align_middle nd_options_border_radius_100_percentage" width="30" src="wp-content/plugins/nd-shortcodes/addons/customizer/shortcodes/login/img/avatar.jpg"></a>
                                                            <div class="nd_options_display_table_cell nd_options_vertical_align_middle">
                                                                <p class="nd_options_font_size_12 nd_options_text_align_left">
                                                                    <a class="nd_options_color_white nd_options_first_font" href="booking-account/index.html">Tài khoản</a>
                                                                </p>
                                                                ...
                                                                <h6 class="nd_options_font_size_10 nd_options_text_align_left nd_options_color_white nd_options_second_font">
                                                                    <a class="nd_options_color_white" href="booking-account/index.html">Đăng nhập</a>
                                                                </h6>
                                                            </div>
                            ...
                            <div class="elementor-element elementor-element-40696cf elementor-widget elementor-widget-image" data-id="40696cf" data-element_type="widget" data-widget_type="image.default">
                                <div class="elementor-widget-container">
                                    <style>
                                        ...
                                        <img width="281" height="91" src="wp-content/uploads/sites/4/2022/05/apartment-logo.png" class="attachment-large size-large" alt="" loading="lazy" /> </a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="elementor-element elementor-element-85b82e9 elementor-align-right elementor-tablet-align-center elementor-widget elementor-widget-button" data-id="85b82e9" data-element_type="widget" data-widget_type="button.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-button-wrapper">
                                        <a href="booking-search/index.html" class="elementor-button-link elementor-button elementor-size-sm" role="button">
